...
large_collection_raw_rdd = sc.textFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/input/large_collection/")
small_collection_raw_rdd = sc.textFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/input/small_collection_limited/")
...
# Because we know the tf is always 1, and we know the count of each word, we can pre-compute the pyspark_tf-idf_text_mining_machine_learning score for each word.
...
# Step 3
# Read and transform the smaller dataset into a word to id_list and pyspark_tf-idf_text_mining_machine_learning score lookup
...
# [(large_collection_word1, (small_collection_id_list, pyspark_tf-idf_text_mining_machine_learning-score)
...
tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")
first_name_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/first_name_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")
last_name_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/last_name_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")
address_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/address_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")

birth_set_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/birth_set_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")
zip_set_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/zip_set_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")
state_set_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/state_set_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")
middle_init_set_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/middle_init_set_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")
city_set_tf_idf_rdd.saveAsPickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/city_set_tf_idf_rdd/" + now.strftime('%m_%d_%Y_%H_%M') + "/")

# On restart of the job
birth_set_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/birth_set_tf_idf_rdd/03_02_2017_21_42/")
zip_set_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/zip_set_tf_idf_rdd/03_02_2017_21_42/")
state_set_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/state_set_tf_idf_rdd/03_02_2017_21_42/")
middle_init_set_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/middle_init_set_tf_idf_rdd/03_02_2017_21_42/")
city_set_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/city_set_tf_idf_rdd/03_02_2017_21_42/")

tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/tf_idf_rdd/02_24_2017_18_00/")
first_name_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/first_name_tf_idf_rdd/03_02_2017_21_42/")
last_name_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/last_name_tf_idf_rdd/03_02_2017_21_42/")
address_tf_idf_rdd = sc.pickleFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/intermediate/address_tf_idf_rdd/03_02_2017_21_42/")
...
for chunk in chunker(range(10000), chunk_size):
    ...
    final_rdd.saveAsTextFile("s3://example_bucket/pyspark_tf-idf_text_mining_machine_learning/output/" + now.strftime('%m_%d_%Y_%H_%M') + "/" + str(counter) + "/")
    counter += chunk_size